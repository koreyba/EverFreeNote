...
export const EditorMenuBar = ({
  ...
  return (
    <TooltipProvider delayDuration={150}>
      <div className="sticky top-0 z-20 flex flex-wrap items-center gap-1.5 border-b border-border/40 bg-background/85 backdrop-blur-md p-2 shadow-sm rounded-t-xl">
