...
- **How to Fix**:
  ...
  >   Element has insufficient color contrast of 3.3 (foreground color: #878c90, background color: #fafcfe, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1
