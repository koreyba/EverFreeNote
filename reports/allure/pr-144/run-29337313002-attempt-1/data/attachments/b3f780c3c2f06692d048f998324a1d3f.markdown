...
- **How to Fix**:
  ...
  >   Element has insufficient color contrast of 3.29 (foreground color: #888d90, background color: #fcfdfe, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1
