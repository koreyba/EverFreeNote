...
```bash
# Android
ls ui/mobile/android/app/src/main/assets/web-editor/

# iOS  
ls ui/mobile/ios/EverFreeNote/WebEditor/
```
...
- Solution: `rm -rf out/` and rebuild
...
ls -lh ui/mobile/android/app/src/main/assets/web-editor/
du -sh ui/mobile/android/app/src/main/assets/web-editor/

# Check build output
npm run build && ls -lh out/editor-webview/
```
