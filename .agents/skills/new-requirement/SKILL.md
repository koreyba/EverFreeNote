...
- Start from `docs/ai/requirements/README.md` â†’ save as `docs/ai/requirements/feature-{name}.md`
- Start from `docs/ai/design/README.md` â†’ save as `docs/ai/design/feature-{name}.md`
- Start from `docs/ai/planning/README.md` â†’ save as `docs/ai/planning/feature-{name}.md`
- Start from `docs/ai/implementation/README.md` â†’ save as `docs/ai/implementation/feature-{name}.md`
- Start from `docs/ai/testing/README.md` â†’ save as `docs/ai/testing/feature-{name}.md`
