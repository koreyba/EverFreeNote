...
- Normalize entry point name to kebab-case (`calculateTotalPrice` â†’ `calculate-total-price`)
...
Let me know the entry point and goals when youâ€™re ready to begin the knowledge capture.
