...
- [ ] Перевести `lib/indexeddb/**` и прочие утилиты/скрипты (`scripts/*.js`) на TS с сохранением функционала (готово: supabase и audit скрипты в `.ts`; остаётся `lib/indexeddb`).
