...
│   ├── RichTextEditor.cy.js   # Тесты RichTextEditor
│   └── InteractiveTag.cy.js   # Тесты других компонентов
...
cypress/
├── e2e/                      # E2E тест файлы
│   ├── basic.cy.js          # Базовая функциональность
│   └── note-management.cy.js # Управление заметками
├── fixtures/                # Тестовые данные
└── support/
    ├── e2e.js              # Настройки для E2E testing
    └── commands.js         # Кастомные команды
```
...
| Создание заметок | ❌ | ✅ | Частично |
| Rich Text Editor | ✅ | ❌ | Начато |
| Поиск | ❌ | ❌ | Запланировано |
